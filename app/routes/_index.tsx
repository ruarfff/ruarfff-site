...
export const meta: MetaFunction = () => [
  { title: "Ruairí's Site" },
  {
    name: "description",
    content:
      "Ruairí's personal site and blog, sharing notes and writeups on programming, machine learning, software engineering, and other technical topics.",
  },
];
          ...
          .map((post) => (
            ...
            >
              <div>
                <Link
                  to={post.slug}
                  className="text-xl md:text-2xl font-semibold no-underline hover:underline text-gray-900 dark:text-gray-100"
                >
                  {post.title}
                </Link>
